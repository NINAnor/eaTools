...
```{r easpread-out, fig.cap="Example where the area weighted averages of the indicator values in the small polygons are spread over the raster cells with each homogeneous area class. Only homogeneous area class with more than 5 data points get indicator values."}
tmap_arrange(
...
```{r}
newIndicator_raster <- stars::st_rasterize(newIndicator, ex_raster_zoom)
```
