...
I'm going to assume for this example that we use expert judgement to say that we need 5 data points to base an average on. If we have less than that we will not attempt to estimate an average.
...
We can do all this with eaTools functions
```{r}
